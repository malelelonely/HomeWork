...
public class HomeWork3 {
    public static void main(String[] args) {
        String firsStudent = "Иванчо";
        String secondStudent = "Ани";
        String thirdStudent = "Марийка";
        String forthStudent = "Пенчо";
        String fifthStudent = "Бориславчо";
        int evaluationOfFirstStudent = 2;
        int evaluationOfSecondStudent = 5;
        int evaluationOfThirdStudent = 6;
